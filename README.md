...
| [**fable-plan**](./fable-plan) | מצב מודל היברידי: Fable 5 מתכנן (plan mode, קונטקסט 1M), Sonnet 5 מבצע. שורת env אחת ב‑settings שגורמת ל‑`/model opusplan` להשתמש בפייבל במקום אופוס. |
