...
| תוסף | מה זה עושה |
|---|---|
| [**tab-status**](./tab-status) | נקודה צבעונית (⚪🔴🟣🟠🔵🟡🟤🟢) על ה‑tab של הטרמינל ב‑VS Code, שמראה אם Claude פנוי, עובד, בונה תוכנית (🟣), מחכה להחלטה שלך על תוכנית (🟠), מחכה לתשובה שלך (🔵), מחכה לסוכן רקע (🟡), או מריץ shell של Bash ברקע (🟤). אחרי עבודה שדחפה ל‑`main`/`master` הירוק מתחלף ב‑✅, כדי לדעת אילו לשוניות כבר עלו לפני שסוגרים אותן. |
